        ...
        for record in self:
            if partner.categ_id.category_type == 'store' or partner.categ_id.category_type == 'tender':
                if product:
                    ...
                    price_unit_wo_discount2 = price_unit_wo_discount1 * (1 - (record.dist_discount or 0.0) / 100.0)
                    price_unit_wo_discount = price_unit_wo_discount2 * (1 - (record.cash_discount or 0.0) / 100.0)
                else:
