odoo.define('mrp_updates.ClientActionMRP', function (require) {
'use strict';
...
var ClientActionMRP = AbstractAction.extend({
    ...
    init: function (parent, action) {
        ...
        this.domain = [['product_id.sale_ok','=',0]];
...
core.action_registry.add('mrp_mrp_client_action', ClientActionMRP);

return ClientActionMRP;

});

odoo.define('mrp_updates.ClientAction_edit', function (require) {
'use strict';
...
var ClientAction_edit = ClientAction.extend({
    ...
    init: function (parent, action) {
        ...
        this.action = action;
        this.context = action.context;
        this.domain = [['product_id.sale_ok','=',"1"]];
        this.companyId = false;
        this.groups = false;
        this.date_range = [];
        this.formatFloat = field_utils.format.float;
...
core.action_registry.add('mrp_mps_client_action', ClientAction_edit);

return ClientAction_edit;
